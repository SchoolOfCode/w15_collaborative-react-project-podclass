...
export const contentData = [
  ...
  },
  {
    ...
    sections: [{key: "1.1",
                ...
                image: "",
                checklist: [{key: "1.1.1", text:"\u2611 decide topic", selected: false, className: "i"},
                            {key: "1.1.2", text:"\u2611 checkout potential ideas", selected: false, className: "hate"},
                            {key: "1.1.3", text:"\u2611 checkout popular podcasts", selected: false, className: "react"}
                        ]
                },
                {key: "1.2",
                subheading:"Format", 
